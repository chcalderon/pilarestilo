  ...
  return (
    <div style={{ position: 'relative' }}>
      <button
        ref={btnRef}
        onClick={() => setOpen(v => !v)}
        className={`relative transition-colors duration-200 p-1 focus:outline-none ${dark ? 'text-pe-white/40 hover:text-pe-rose-soft' : 'text-pe-charcoal/50 hover:text-pe-rose'}`}
