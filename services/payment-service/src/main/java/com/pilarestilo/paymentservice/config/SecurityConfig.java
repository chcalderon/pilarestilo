package com.pilarestilo.paymentservice.config;

import com.pilarestilo.paymentservice.auth.JwtAuthenticationFilter;
    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        return http
                .authorizeHttpRequests(auth -> auth
                        ...
                        .requestMatchers(HttpMethod.GET, "/api/payments/_health").permitAll()
