...
class PaymentEventListenerTest {
    ...
    void confirms_payment_from_created_moves_to_paid_via_pending_payment() {
        ...
        listener.onPaymentConfirmed(new PaymentConfirmed(UUID.randomUUID(), orderId, Instant.now()));
    ...
    void rejects_payment_cancels_order_and_releases_all_items() {
        ...
        listener.onPaymentRejected(new PaymentRejected(UUID.randomUUID(), orderId, UUID.randomUUID(), Instant.now()));
